...
//animation in view on scroll
    ...
    $(document).scroll(function() { 
        ...
        if(scrollPosition > 300) {
            $(".navbar").css('background-color', 'rgba(247, 247, 247, 1)');
            $(".navbar").css('opacity', '1');
            $(".navbar").css('transition', '0.9s');
        }else {
...
// create navbar animation
    let navLinks = document.querySelectorAll('.navbar-list li');
    ...
    $('.navbar-list-item-link').on('click',function() {
    ...
    $('.navbar-list-item-link').click(function(e){
